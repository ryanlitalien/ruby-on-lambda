          ...
          <div class="row">
            <div class="col-md-12">
              <div class="input-group mb-3">
                <input id="numberSearch" type="text" class="form-control"
                       autofocus="autofocus"
                       placeholder="603-555-1234" aria-label="Phone number lookup" aria-describedby="search-submit">
              ...
              <a href="sms://+18573052778" role="button" id="sms-button"
